...
export const initialProducts: Product[] = [
  ...
  { id:  9, name: 'Apex SIF Growth Fund',        assetClass: 'SIF', category: 'Strategic', return1y: '+18.5%', minInvest: '₹10,00,000',  nav: '₹1,240.00', visibility: 'Platinum Only',  riskLevel: 'High',      status: 'Active', amc: 'Apex Wealth'    },
  { id: 10, name: 'Apex SIF Income Fund',        assetClass: 'SIF', category: 'Strategic', return1y: '+12.2%', minInvest: '₹5,00,000',   nav: '₹880.50',   visibility: 'Gold & Above',   riskLevel: 'Moderate',  status: 'Active', amc: 'Apex Wealth'    },
];
