-- Anita: assign a fresh sandbox KYC-ready PAN (AVRMPX3751V) so Finprim POST creates
-- a new profile with occupation instead of reusing poisoned invp_* rows from prior PANs.
UPDATE investors
SET pan                     = 'AVRMPX3751V',
